...
<div class="col-md-8">
	<img class="pull-left" src="<?php bloginfo('template_directory'); ?>/dist/images/3d-map.jpeg" alt="3D Map">
		...
		<aside class="col-md-4">
			<p>We work with small-, medium-, and large-sized businesses to help them either get started or expand into new territories. Start your next chapter now.</p>
			<p>If you have a portfolio of properties you're moving, or if you have just a single spot, we'll connect you with potential buyers.</p>
			<p>
